...
module.exports = {
    head: {
        ...
        meta: [
            ...
            { hid: 'twitter-image', name: 'twitter:image', content: 'https://kurozeropb.info/jeanne/avatar.jpg' },
            ...
            { hid: 'og-image', property: 'og:image', content: 'https://kurozeropb.info/jeanne/avatar.jpg' },
            { hid: 'og-type', property: 'og:type', content: 'website' },
            { hid: 'og-site_name', property: 'og:site_name', content: 'kurozeropb.info/jeanne' },
            ...
            { hid: 'msapplication-config', property: 'msapplication-config', content: 'https://kurozeropb.info/jeanne/head-icons/browserconfig.xml' }
        ],
        link: [
